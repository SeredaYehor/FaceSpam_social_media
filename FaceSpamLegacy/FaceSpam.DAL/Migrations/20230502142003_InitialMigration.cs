        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageReference = table.Column<string>(type: "nvarchar(255)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserFollowingsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserUser", x => new { x.UserFollowingsId, x.UserId });
                    table.ForeignKey(
                        name: "FK_UserUser_Users_UserFollowingsId",
                        column: x => x.UserFollowingsId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
